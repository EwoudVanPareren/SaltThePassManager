 ...
 *
 * Unless [overrideTheme] is set, the app's configuration
 * is used to pick the theme.
 */
@Composable
fun SaltThePassManagerTheme(
    overrideTheme: Configuration.Theme? = null,
    content: @Composable () -> Unit
) {
    val theme = overrideTheme ?: LocalAppConfiguration.current.theme
