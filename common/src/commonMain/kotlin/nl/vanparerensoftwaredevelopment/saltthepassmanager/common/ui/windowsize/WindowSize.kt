package nl.vanparerensoftwaredevelopment.saltthepassmanager.common.ui.windowsize
 ...
 * though it should only be used for making choices on a window
 * or screen level.
 *
...
data class WindowSize(
    ...
    companion object {
        ...
        fun from(size: DpSize) = from(size.width, size.height)
