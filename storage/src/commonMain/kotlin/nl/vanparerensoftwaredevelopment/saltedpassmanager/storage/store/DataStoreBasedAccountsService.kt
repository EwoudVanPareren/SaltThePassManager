...
import nl.vanparerensoftwaredevelopment.saltedpassmanager.storage.AccountAlreadyExistsException
import nl.vanparerensoftwaredevelopment.saltedpassmanager.storage.AccountNotFoundException
...
import nl.vanparerensoftwaredevelopment.saltedpassmanager.storage.ext.associateByMulti
import nl.vanparerensoftwaredevelopment.saltedpassmanager.storage.ext.lowercaseUS
import nl.vanparerensoftwaredevelopment.saltedpassmanager.storage.ext.toCountMap
...
internal class DataStoreBasedAccountsService(
    ...
    override val allAccounts: Flow<List<StoredAccount>> = store.updates
        .map { accountsFile ->
            accountsFile.items.sortedBy { it.key.domainName }
        }
